...
def generate_music():
    try:
        ...
        # Session Init
        scraper.get("https://notegpt.io/ai-music-generator")
        ...
        res = scraper.post("https://notegpt.io/api/v2/music/generate", json=payload, cookies=cookies, headers=headers)
...
def get_status():
    ...
    res = scraper.get(f"https://notegpt.io/api/v2/music/status?conversation_id={cid}")
    return jsonify(res.json())
